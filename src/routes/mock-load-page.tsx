...
const MockLoadPage = () => {
    ...
    const [interview, setInteview] = useState<Interview | null>(null)
            ...
            if (interviewId) {
                try {
                    ...
                    if (interviewDoc.exists()) {
                        setInteview({ id: interviewDoc.id, ...interviewDoc.data() } as Interview)
                    }
                } catch (error) {
                    console.log(error)
                }
            ...
            <Alert className="bg-yellow-100/50 border-yellow-200 p-4 rounded-lg flex items-start gap-3 -mt-3">
                ...
                <div>
                    ...
                    <AlertDescription className="text-sm text-yellow-700 mt-1">
                        ...
                        receive a personalized report based on your responses at the end.<span className="font-medium">Note:</span> Your video is never recorded. You can disable your webcam at any time.
                    </AlertDescription>
                </div>
            </Alert>
